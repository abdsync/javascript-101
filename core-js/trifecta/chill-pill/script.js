const quoteList = [
  ...
  quoteButton.addEventListener("click", function() 
  {
    ...
    let changecolor = colors[randomIndex];
    wrapperDiv.style.backgroundColor = changecolor;
  });

  /* Crux of the story: Whenever the button is clicked the funciton invokes
  that sets the value of randomIndex to some value which is used to navigate 
  the quotes in the array and store it in random Quote. The same is done for
  color so each time button is clicked new color is added to wrapperDiv. */
